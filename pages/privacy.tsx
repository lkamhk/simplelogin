  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center justify-center  p-5">
        <h1 className='font-bold text-5xl my-5'>Privacy Policy</h1>
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Simple Login.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to Simple Login, accessible from <a href="https://simplelogin-aydan.vercel.app" rel="external nofollow noopener" target="_blank">https://simplelogin-aydan.vercel.app</a></p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: aydanlau@outlook.com</li>
        </ul>
      </div>
    </>
  );
